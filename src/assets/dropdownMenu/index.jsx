...
function DropdownMenu(props) {
  ...
  const { handleLogout, isColumnist } = useContext(Context)
  ...
  return ( 
    <Fragment>
      <div className='dropdown-menu-conteiner'>
        ...
        { isColumnist === false && <button className='dropdown-button' ><IoHeartOutline className='dropdown-button-icon' /><p className='small dropdown-button-text'>Favorites</p></button>}
